...
public class Searcher {
	...
	public static void main(String[] args) {
		...
		producer.send(new ProducerRecord<String,Set<Result>>(args[0], googleImages));
		producer.send(new ProducerRecord<String,Set<Result>>(args[0], bingImages));	
		producer.send(new ProducerRecord<String,Set<Result>>(args[0], flickrImages));	
